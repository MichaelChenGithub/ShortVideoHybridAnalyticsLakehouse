...
def write_run_artifacts(
    ...
    user_registry_rows: List[Dict[str, Any]],
    ...
    user_registry_path = run_dir / "user_registry.parquet"
    ...
    user_registry_format = _write_parquet_or_jsonl(user_registry_path, user_registry_rows)
