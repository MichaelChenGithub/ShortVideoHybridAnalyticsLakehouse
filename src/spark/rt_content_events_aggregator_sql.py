"""SQL builders and schema contract helpers for MIC-40 content aggregator."""
...
try:
    from spark.rt_content_events_contract import RAW_EVENTS_TABLE, RT_VIDEO_STATS_1MIN_TABLE
except ModuleNotFoundError:  # pragma: no cover - direct spark-submit fallback
    from rt_content_events_contract import RAW_EVENTS_TABLE, RT_VIDEO_STATS_1MIN_TABLE
