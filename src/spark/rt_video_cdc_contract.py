...
CHECKPOINT_RAW_CDC_VIDEOS = "s3a://checkpoints/jobs/spark_rt_video_cdc_upsert/raw_cdc_videos/v1"
...
ENV_CHECKPOINT_RAW_CDC_VIDEOS = "RT_VIDEO_CDC_CHECKPOINT_RAW"
...
ENV_RAW_CDC_TABLE = "RT_VIDEO_CDC_RAW_TABLE"
