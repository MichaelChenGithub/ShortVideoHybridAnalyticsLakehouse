...
2. Data model: `docs/architecture/data-model/data-model-contract.md`
3. Messaging contract: `docs/architecture/messaging/kafka-topic-schema-retention-contract.md`
...
2. output tables and grains match `data-model-contract.md`
