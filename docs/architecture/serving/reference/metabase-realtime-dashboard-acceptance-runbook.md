# Metabase Realtime Dashboard Acceptance Runbook
## 1. Purpose and Scope

This runbook defines how to use the Metabase Realtime Dashboard SQL pack for:
...
1. `artifacts/metabase_realtime_dashboard_signoff/<RUN_ID>/`
...
2. Recommendation preview in this runbook is traceability-oriented (`decision_type_preview`), not production action execution state.
