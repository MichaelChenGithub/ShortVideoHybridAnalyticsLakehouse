# Design Doc: Trino Batch Semantic Serving Contract (M2)
...
3. `docs/architecture/batch-analytics/batch-metrics-contract-m2.md`
4. `docs/architecture/batch-analytics/batch-jobs-and-orchestration-contract-m2.md`
...
1. engagement rate formulas are governed by `docs/architecture/batch-analytics/batch-metrics-contract-m2.md`.
...
2. sessionization metric formulas are governed by `docs/architecture/batch-analytics/batch-metrics-contract-m2.md`.
...
1. batch metric formulas and denominator protections are governed by:
   - `docs/architecture/batch-analytics/batch-metrics-contract-m2.md`
