...
2. table grain/field contracts: `docs/architecture/data-model/m1-data-model-v1.md`
3. quality gates: `docs/architecture/quality/dbt-semantic-quality-contract-m2.md`
4. publish schedule/orchestration: `docs/architecture/batch-analytics/batch-jobs-and-orchestration-contract-m2.md`
