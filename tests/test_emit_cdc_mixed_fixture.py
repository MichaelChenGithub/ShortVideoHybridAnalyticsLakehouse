...
from scripts.emit_cdc_mixed_fixture import (  # noqa: E402
    DEFAULT_BASE_TS_MS,
...
class EmitCdcMixedFixtureTests(unittest.TestCase):
    ...
    def test_fixture_contains_one_malformed_json_record(self) -> None:
        records, _ = build_mixed_fixture_records("cdc_contract_vid_002")
        malformed_count = 0
    ...
    def test_fixture_is_deterministic_for_same_input(self) -> None:
        left_records, left_summary = build_mixed_fixture_records("cdc_contract_vid_003")
        right_records, right_summary = build_mixed_fixture_records("cdc_contract_vid_003")
